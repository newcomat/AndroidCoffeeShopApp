...
public class Database extends AppCompatActivity {
    ...
    ArrayList<String> item_id, item_name, item_description, item_size, item_notes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_notes = new ArrayList<>();

        storeDataInArrays();

        customAdapter = new CustomAdapter(Database.this, this, item_id, item_name, item_description,
                item_size, item_notes);
    ...
    void storeDataInArrays() {
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                item_notes.add(cursor.getString(4));
            }
